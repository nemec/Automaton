...
class Calendar(automaton.lib.plugin.PluginInterface):
  ...
  def __init__(self, registrar):
    ...
    self.settings = settings_loader.load_plugin_settings(self.__class__.__name__)
    ...
    self.cal_client = gdata.calendar.client.CalendarClient(source='Automaton-CalendarPlugin-0.1')
    self.cal_client.ClientLogin(self.settings["EMAIL"], self.settings["PASSWORD"], self.cal_client.source);
